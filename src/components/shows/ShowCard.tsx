...
import { HoverCardProps } from './show-type';
import { Avatar, AvatarFallback, AvatarImage } from '../ui/avatar';

export function ShowCard({ show }: { show: ShowProps }) {
  const [isHovered, setIsHovered] = useState(false);
  const [hoverCardDetails, setHoverCardDetails] = useState<HoverCardProps | null>(null);
          ...
          <div className="flex">
            ...
            <div className="flex flex-col m-4 justify-around items-center">
              ...
              <div className="text-sm text-gray-500 flex items-center">
                {hoverCardDetails?.number_of_seasons} seasons,{' '}
                {hoverCardDetails?.number_of_episodes} episodes
              </div>
